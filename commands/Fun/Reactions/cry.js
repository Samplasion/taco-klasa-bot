...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            ...
            description: 'Cry with this.',
        });
      this.randomColor = "#000000".replace(/0/g, function () { return (~~(Math.random() * 16)).toString(16); });
    }

    async run(msg) {
      const someone = msg.mentions.members.first() != undefined ? msg.mentions.members.first().user : msg.author;
      this.getImage(msg, "cry", someone)
    }
    ...
    async getImage(msg, type, user) {
      ...
      const embed = new this.client.methods.Embed()
        ...
        .setTitle(`${msg.member.displayName} cried`)
