...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			MONITOR_COMMAND_HANDLER_REPROMPT: (tag, error, time) => `${tag} | **${error}** | Hai **${time}** secondi per rispondere a questo messaggio con un argomento valido. Scrivi **"ABORT"** per annullare.`, // eslint-disable-line max-len
			...
			COMMAND_INFO: [
				...
				'La maggior parte del codice è modularizzato, questo permette agli sviluppatori di modificare Klasa per adattarlo alle proprie richieste.',
				'',
